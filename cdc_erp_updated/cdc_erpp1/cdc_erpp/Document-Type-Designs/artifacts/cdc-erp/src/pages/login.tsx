...
import { AlertCircle, Lock, User, ArrowLeft, LogIn } from "lucide-react";
...
export default function Login() {
  ...
  const fromModule = typeof window !== "undefined" && new URLSearchParams(window.location.search).get("from") === "module";
    ...
    <div className="min-h-screen flex flex-col bg-slate-100">
      ...
      <div className="flex-1 flex overflow-hidden min-h-0">
        ...
        <div className="flex flex-col w-full lg:w-[420px] flex-shrink-0 bg-white shadow-2xl z-10">
          ...
          {/* Branding */}
          <div className="bg-gradient-to-br from-green-800 to-teal-700 text-white px-8 py-10 flex-shrink-0 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2" />
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/5 rounded-full translate-y-1/2 -translate-x-1/2" />
            <div className="relative flex flex-col items-center text-center gap-4">
              <img src="/logo.webp" alt="Logo" className="h-16 md:h-20 w-auto object-contain" />
              <div>
